...
avr-g++ client.cpp $(find atmega328p/includes/. -type f -iregex ".*\.cpp") $(find atmega328p/includes/. -type f -iregex ".*\.c") -w -o main -Iatmega328p/includes/core -Iatmega328p/includes/ -lm -mmcu=atmega328 -DF_CPU=16000000UL -Os &&
...
if [ $1 == "-S" ]; then
avr-g++ -S client.cpp -Iatmega328p/includes/core -Iatmega328p/includes/ -lm -mmcu=atmega328 -DF_CPU=16000000UL -Os  &&
