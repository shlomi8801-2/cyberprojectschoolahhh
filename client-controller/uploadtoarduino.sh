...
avr-g++ $(find atmega328p/includes/. -type f -iregex ".*\.cpp") $(find atmega328p/includes/. -type f -iregex ".*\.c") -w -o main -lm -Iatmega328p/includes/core -Iatmega328p/includes/ -Os &&
...
if [ $1 == "-S" ]; then
avr-g++ -S $(find atmega328p/includes/. -type f -iregex ".*\.cpp") $(find atmega328p/includes/. -type f -iregex ".*\.c") -lm -Iatmega328p/includes/core -Iatmega328p/includes/ -Os &&
